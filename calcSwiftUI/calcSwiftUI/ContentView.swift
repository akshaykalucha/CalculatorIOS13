        ...
        NavigationView {
            ScrollView{
                VStack{
                    ...
                    //Toggle List View
                    VStack{
                        NavigationLink(destination: DetailView(heading: "My Orders History"), label: {
                        ...
                        VStack{
                            RoundedRectangle(cornerRadius: 25)
                                ...
                                .overlay(
                                    HStack{
                                        VStack(alignment: .leading){
                                            Text("Refer a friends & Earn").font(.system(size: 15, weight: .light, design: .default))
